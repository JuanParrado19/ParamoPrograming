...
const Home = () => (
    <section id="hero" className="d-flex align-items-center justify-content-center">
        ...
        <Container className="container position-absolute " style={{ padding: '5vh', zIndex:'-1' }} >
            ...
            <Container className="d-flex justify-content-center">
                <a href='#start'><FontAwesomeIcon icon="chevron-down" size='2xl' className=" " style={{ color: "#ffffff" }} /></a>
            </Container>
        </Container>
